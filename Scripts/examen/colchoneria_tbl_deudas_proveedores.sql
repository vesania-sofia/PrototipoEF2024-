...
--
-- Dumping data for table `tbl_deudas_proveedores`
--

LOCK TABLES `tbl_deudas_proveedores` WRITE;
/*!40000 ALTER TABLE `tbl_deudas_proveedores` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_deudas_proveedores` ENABLE KEYS */;
UNLOCK TABLES;
