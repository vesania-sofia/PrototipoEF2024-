...
--
-- Dumping data for table `tbl_planilla_encabezado`
--

LOCK TABLES `tbl_planilla_encabezado` WRITE;
/*!40000 ALTER TABLE `tbl_planilla_encabezado` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_planilla_encabezado` ENABLE KEYS */;
UNLOCK TABLES;
