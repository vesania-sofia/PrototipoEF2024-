...
--
-- Dumping data for table `tbl_receta_detalle`
--

LOCK TABLES `tbl_receta_detalle` WRITE;
/*!40000 ALTER TABLE `tbl_receta_detalle` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_receta_detalle` ENABLE KEYS */;
UNLOCK TABLES;
