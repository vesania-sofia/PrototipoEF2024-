...
--
-- Dumping data for table `tbl_lotes_detalles`
--

LOCK TABLES `tbl_lotes_detalles` WRITE;
/*!40000 ALTER TABLE `tbl_lotes_detalles` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_lotes_detalles` ENABLE KEYS */;
UNLOCK TABLES;
