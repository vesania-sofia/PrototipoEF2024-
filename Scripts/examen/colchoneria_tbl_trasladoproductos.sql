...
--
-- Dumping data for table `tbl_trasladoproductos`
--

LOCK TABLES `tbl_trasladoproductos` WRITE;
/*!40000 ALTER TABLE `tbl_trasladoproductos` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_trasladoproductos` ENABLE KEYS */;
UNLOCK TABLES;
