...
--
-- Dumping data for table `tbl_cierre_produccion`
--

LOCK TABLES `tbl_cierre_produccion` WRITE;
/*!40000 ALTER TABLE `tbl_cierre_produccion` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_cierre_produccion` ENABLE KEYS */;
UNLOCK TABLES;
