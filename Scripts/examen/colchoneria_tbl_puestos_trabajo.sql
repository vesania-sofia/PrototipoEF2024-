...
--
-- Dumping data for table `tbl_puestos_trabajo`
--

LOCK TABLES `tbl_puestos_trabajo` WRITE;
/*!40000 ALTER TABLE `tbl_puestos_trabajo` DISABLE KEYS */;
INSERT INTO `tbl_puestos_trabajo` VALUES (1,'examen','examen',1);
/*!40000 ALTER TABLE `tbl_puestos_trabajo` ENABLE KEYS */;
UNLOCK TABLES;
