...
--
-- Dumping data for table `tbl_proceso_produccion_encabezado`
--

LOCK TABLES `tbl_proceso_produccion_encabezado` WRITE;
/*!40000 ALTER TABLE `tbl_proceso_produccion_encabezado` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_proceso_produccion_encabezado` ENABLE KEYS */;
UNLOCK TABLES;
