...
--
-- Dumping data for table `tbl_control_anticipos`
--

LOCK TABLES `tbl_control_anticipos` WRITE;
/*!40000 ALTER TABLE `tbl_control_anticipos` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_control_anticipos` ENABLE KEYS */;
UNLOCK TABLES;
