...
--
-- Dumping data for table `tbl_identidadactivo`
--

LOCK TABLES `tbl_identidadactivo` WRITE;
/*!40000 ALTER TABLE `tbl_identidadactivo` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_identidadactivo` ENABLE KEYS */;
UNLOCK TABLES;
