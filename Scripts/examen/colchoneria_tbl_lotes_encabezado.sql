...
--
-- Dumping data for table `tbl_lotes_encabezado`
--

LOCK TABLES `tbl_lotes_encabezado` WRITE;
/*!40000 ALTER TABLE `tbl_lotes_encabezado` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_lotes_encabezado` ENABLE KEYS */;
UNLOCK TABLES;
