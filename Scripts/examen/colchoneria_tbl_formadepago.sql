...
--
-- Dumping data for table `tbl_formadepago`
--

LOCK TABLES `tbl_formadepago` WRITE;
/*!40000 ALTER TABLE `tbl_formadepago` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_formadepago` ENABLE KEYS */;
UNLOCK TABLES;
