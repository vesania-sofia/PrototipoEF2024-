...
--
-- Dumping data for table `tbl_proceso_produccion_detalle`
--

LOCK TABLES `tbl_proceso_produccion_detalle` WRITE;
/*!40000 ALTER TABLE `tbl_proceso_produccion_detalle` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_proceso_produccion_detalle` ENABLE KEYS */;
UNLOCK TABLES;
