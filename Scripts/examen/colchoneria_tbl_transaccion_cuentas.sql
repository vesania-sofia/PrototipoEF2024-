...
--
-- Dumping data for table `tbl_transaccion_cuentas`
--

LOCK TABLES `tbl_transaccion_cuentas` WRITE;
/*!40000 ALTER TABLE `tbl_transaccion_cuentas` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_transaccion_cuentas` ENABLE KEYS */;
UNLOCK TABLES;
