...
--
-- Dumping data for table `tbl_movimientobancario`
--

LOCK TABLES `tbl_movimientobancario` WRITE;
/*!40000 ALTER TABLE `tbl_movimientobancario` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_movimientobancario` ENABLE KEYS */;
UNLOCK TABLES;
