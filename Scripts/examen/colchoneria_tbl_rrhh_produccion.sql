...
--
-- Dumping data for table `tbl_rrhh_produccion`
--

LOCK TABLES `tbl_rrhh_produccion` WRITE;
/*!40000 ALTER TABLE `tbl_rrhh_produccion` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rrhh_produccion` ENABLE KEYS */;
UNLOCK TABLES;
