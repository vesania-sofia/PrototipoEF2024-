...
--
-- Dumping data for table `tbl_tipoactivofijo`
--

LOCK TABLES `tbl_tipoactivofijo` WRITE;
/*!40000 ALTER TABLE `tbl_tipoactivofijo` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_tipoactivofijo` ENABLE KEYS */;
UNLOCK TABLES;
