...
--
-- Dumping data for table `tbl_horas_extra`
--

LOCK TABLES `tbl_horas_extra` WRITE;
/*!40000 ALTER TABLE `tbl_horas_extra` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_horas_extra` ENABLE KEYS */;
UNLOCK TABLES;
