...
--
-- Dumping data for table `tbl_maquinaria`
--

LOCK TABLES `tbl_maquinaria` WRITE;
/*!40000 ALTER TABLE `tbl_maquinaria` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_maquinaria` ENABLE KEYS */;
UNLOCK TABLES;
