...
--
-- Dumping data for table `tbl_rango_fechas`
--

LOCK TABLES `tbl_rango_fechas` WRITE;
/*!40000 ALTER TABLE `tbl_rango_fechas` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rango_fechas` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-11-11  9:41:48
