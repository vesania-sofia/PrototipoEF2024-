...
--
-- Dumping data for table `tbl_control_faltas`
--

LOCK TABLES `tbl_control_faltas` WRITE;
/*!40000 ALTER TABLE `tbl_control_faltas` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_control_faltas` ENABLE KEYS */;
UNLOCK TABLES;
