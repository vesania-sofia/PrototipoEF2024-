...
--
-- Dumping data for table `tbl_destinatario`
--

LOCK TABLES `tbl_destinatario` WRITE;
/*!40000 ALTER TABLE `tbl_destinatario` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_destinatario` ENABLE KEYS */;
UNLOCK TABLES;
