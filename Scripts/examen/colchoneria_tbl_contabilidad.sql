...
--
-- Dumping data for table `tbl_contabilidad`
--

LOCK TABLES `tbl_contabilidad` WRITE;
/*!40000 ALTER TABLE `tbl_contabilidad` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_contabilidad` ENABLE KEYS */;
UNLOCK TABLES;
