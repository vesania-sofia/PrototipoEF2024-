...
--
-- Dumping data for table `tbl_asignacion_vacaciones`
--

LOCK TABLES `tbl_asignacion_vacaciones` WRITE;
/*!40000 ALTER TABLE `tbl_asignacion_vacaciones` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_asignacion_vacaciones` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-11-11  9:41:42
