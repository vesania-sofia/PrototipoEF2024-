...
--
-- Dumping data for table `tbl_remitente`
--

LOCK TABLES `tbl_remitente` WRITE;
/*!40000 ALTER TABLE `tbl_remitente` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_remitente` ENABLE KEYS */;
UNLOCK TABLES;
