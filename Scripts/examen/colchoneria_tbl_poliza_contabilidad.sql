...
--
-- Dumping data for table `tbl_poliza_contabilidad`
--

LOCK TABLES `tbl_poliza_contabilidad` WRITE;
/*!40000 ALTER TABLE `tbl_poliza_contabilidad` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_poliza_contabilidad` ENABLE KEYS */;
UNLOCK TABLES;
