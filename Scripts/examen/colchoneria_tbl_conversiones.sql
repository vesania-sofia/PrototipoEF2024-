...
--
-- Dumping data for table `tbl_conversiones`
--

LOCK TABLES `tbl_conversiones` WRITE;
/*!40000 ALTER TABLE `tbl_conversiones` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_conversiones` ENABLE KEYS */;
UNLOCK TABLES;
