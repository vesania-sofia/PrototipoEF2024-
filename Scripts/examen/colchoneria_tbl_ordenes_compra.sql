...
--
-- Dumping data for table `tbl_ordenes_compra`
--

LOCK TABLES `tbl_ordenes_compra` WRITE;
/*!40000 ALTER TABLE `tbl_ordenes_compra` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_ordenes_compra` ENABLE KEYS */;
UNLOCK TABLES;
